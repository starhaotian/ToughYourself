...
到了约定日期，再根据真实发生的事情标记“对了、错了、还是一半”，并写下总结。长期积累后，你得到的不是一本流水账，而是一份关于自己如何判断、如何犯错、又如何变得更可靠的个人档案。
...
- 用日历查看决策的记录日与复盘日
- 每条决策可标记「工作」或「生活」，日历上可按类别筛选，列表按类别着色区分
- 记录多个选项，以及各自的好处和代价，并单独写下最终决策的原因
- 预先设定复盘日期和具体检验标准
- 到期写下“对 / 错 / 一半”的结论和总结
- 「反思」：另一种内容，只有主题和想说的话，落在某一天；日历格子里以「省」章行呈现，与决策一起同步
- 「问春风」AI 点评：在决策查看页一键请 Qoder Cloud Agents 的 Agent 做旁观者点评（四段式：点评 / 盲点 / 到期 / 结论），支持再问一次
- 结论确定后可继续追加留言，也可更改结论
...
- AI 点评：只保留最新一次，随决策文档一起同步；每次点评消耗 Qoder 账号的 credits；点评会话以「点评 · 决策标题」命名保留在 Qoder 账号里，可在控制台回溯
